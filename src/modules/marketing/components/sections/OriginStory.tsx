...
export function OriginStory() {
  return (
    <section className="mx-auto max-w-[1200px] px-7 py-20">
      <div className="grid grid-cols-1 items-center gap-[30px] rounded-[22px] border border-azure/[0.22] bg-[linear-gradient(135deg,rgba(61,158,232,0.06),rgba(18,31,61,0.4))] p-10 sm:grid-cols-[auto_1fr]">
