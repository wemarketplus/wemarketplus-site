...
import type { SecurityIcon } from '../../types/landingTypes';

// One distinct icon per security card — mirrors the live #security grid
// (lock / document / user / pulse / clock / shield).
const ICON: Record<SecurityIcon, LucideIcon> = {
  encryption: Lock,
  baa: FileText,
  roles: User,
  audit: Activity,
...
export function SecurityGrid() {
  return (
    ...
    >
      ...
      />
      {/* auto-rows-fr + h-full → every security card shares one row height. */}
      <div className="grid auto-rows-fr grid-cols-1 gap-4 text-left sm:grid-cols-2 lg:grid-cols-3">
