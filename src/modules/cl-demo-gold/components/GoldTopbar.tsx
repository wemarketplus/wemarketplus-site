import { PRICING_HREF, SUBTITLE } from '../constants/goldNav';
...
// "Subscribe to Gold CRM" CTA.
export function GoldTopbar() {
  const { pageTitle } = useGoldDemo();
