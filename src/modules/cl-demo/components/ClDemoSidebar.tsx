...
import { NAV, ROLE_LABELS } from '../constants/clDemoNav';
...
export function ClDemoSidebar() {
  ...
  return (
    <aside className="flex h-screen w-[224px] min-w-[224px] flex-col overflow-hidden border-r border-white/[0.08] bg-[#060e1b]">
      {/* .sb-top */}
      <div className="flex-shrink-0 px-3 pb-2.5 pt-3.5">
        ...
        <div className="mb-2.5 flex items-center gap-[9px]">
          ...
          <div>
            ...
            <div className="text-[9px] font-extrabold uppercase tracking-[0.08em] text-[#f59e0b]">
              Pro CRM Demo
            </div>
          </div>
        </div>
        ...
        <div className="mb-1.5 rounded-[10px] border border-[#f59e0b]/[0.12] bg-[#f59e0b]/[0.05] px-[11px] py-[9px]">
          <div className="mb-[5px] text-[9px] font-extrabold uppercase tracking-[0.1em] text-[#4b6278]">
            Viewing As
          </div>
          <select
            value={role}
      ...
      <nav className="flex-1 overflow-y-auto px-2 pb-2" aria-label="Demo navigation">
        {NAV[role].map((group) => (
          <div key={group.sec}>
            <span className="block px-1.5 pb-[3px] pt-2.5 text-[9px] font-black uppercase tracking-[0.12em] text-[#1e3a5f]">
              {group.sec}
            </span>
      ...
      {/* .sb-foot */}
      <div className="flex-shrink-0 border-t border-white/[0.07] px-3 py-2.5 text-center text-[10px] text-[#2c4460]">
        CommunityLink Pro CRM Demo •{' '}
        <a href="/communitylink" className="text-[#f59e0b] no-underline">
          Back to Site
        </a>
      </div>
    </aside>
