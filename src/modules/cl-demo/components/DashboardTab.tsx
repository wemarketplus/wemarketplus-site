...
import { activeLeadCount, moveInCount, openTasks, reimbursable, totalMiles } from '../utils/clDemoFormat';
...
export function DashboardTab() {
  ...
  const miles = totalMiles(mileage);
  ...
  return (
    <>
      <StatGrid>
        ...
        <StatTile label="Open Tasks" value={openTaskCount} valueClassName="text-[#f87171]" sub="Need attention" subClassName="text-[#f87171]" onClick={() => actions.setTab('tasks')} />
      </StatGrid>
