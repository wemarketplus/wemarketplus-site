    ...
    <>
      <Card title="Community Settings">
        <div className="mb-3 grid grid-cols-2 gap-3">
          <Field label="Community Name"><input autoComplete="off" className={FI} defaultValue="Sunrise Senior Living" /></Field>
          <Field label="Total Units"><input autoComplete="off" className={FI} type="number" defaultValue={apts.length} /></Field>
          <Field label="Phone"><input autoComplete="off" className={FI} defaultValue="(214) 555-0100" /></Field>
          <Field label="City"><input autoComplete="off" className={FI} defaultValue="Dallas, TX" /></Field>
        </div>
